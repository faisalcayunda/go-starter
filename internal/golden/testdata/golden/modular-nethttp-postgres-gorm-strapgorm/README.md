...
- **Module path:** `example.com/shopmod`
...
```
cmd/shopmod/main.go   composition root TUNGGAL — rakit semua domain + server
internal/
...
3. **Composition root (`cmd/shopmod/main.go`) satu-satunya tempat
