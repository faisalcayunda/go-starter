// Package core memuat detail implementasi domain Product (model + lapisan akses
// + handler) pada modular monolith. Paket ini terkurung di internal/modules/
// product/internal/core — menurut semantik direktori internal/ Go ia HANYA bisa
// di-import dari bawah internal/modules/product/, jadi domain lain TIDAK dapat
// menyentuhnya. Akses publik domain hanya lewat facade paket product.
//
// Akses data memakai strapgorm (Strapi-style query builder di atas GORM) pada
// *gorm.DB yang di-INJECT facade (REUSE koneksi access=gorm — tanpa pool kedua).
package core
